<template>
    <section class="text-white mt-18 min-h-screen flex flex-col justify-center" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1 w-full h-full">
                ...
                <div class="space-y-8 py-8">
                    ...
                    >
                        ...
                        <div class="w-3/4 pl-4">
                            ...
                            <p class="text-white font-semibold">{{ element.academicAward }}</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8">
                    I’m an experienced IT professional specializing in web and mobile development, cybersecurity, and database management. With a strong focus on innovative design and robust security, I build solutions that enhance user experiences and anticipate future needs, delivering high-quality, reliable applications tailored to meet diverse business goals.
                </p>
...
const education = ref([
    ...
    },
    {
        ...
        academicAward: 'With Highest Honors',
        year: '2016',
    },
    {
        id: 3,
        School: 'Caraga State University',
        program: 'Doctorate in Information Technology',
        academicAward: 'With Distinction',
        year: '2022',
    },
]);
