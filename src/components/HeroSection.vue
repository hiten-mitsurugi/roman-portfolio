<template>
    <section class="relative w-full min-h-screen" data-aos="zoom-in-up">
                ...
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-6xl">
                            Hi, I'm <span
                                class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-pink-500">Roman</span>
                            😁
                        </h1>
                    </div>
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl">
                        I am an IT professional dedicated to creating innovative solutions that enhance efficiency and improve user experiences. With expertise in software development and system management, I excel at tackling complex challenges to deliver results aligned with business objectives.
                    </p>
                ...
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            ...
                            <img src="@/assets/1234.jpg" alt="Hero pic" width="500" height="auto" loading="lazy"
